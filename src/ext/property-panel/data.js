  ...
  tableCellColoring: {
    ...
    items: [
      ...
      },
      {
        ...
        ref: "qExpression",
        expressionType: "measure",
        translation: "Выражение для цвета фона (Итого)",
        defaultValue: "",
        id: "cellTotalBackgroundColor",
        tid: "tableColorTotalBgByExpression",
      },
      {
        component: "expression",
        ref: "qExpression",
        expressionType: "measure",
        translation: "Выражение для цвета текста (Итого)",
        defaultValue: "",
        id: "cellTotalColor",
        tid: "tableColorTotalByExpression",
      },
      {
        component: "expression",
        ref: "qExpression",
